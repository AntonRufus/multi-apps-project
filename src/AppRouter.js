...
const AppRouter = () => (
  <Switch>
    ...
    <Route path="/pomodoro_timer">
      <PomodoroTimer />
    </Route>
    <Route path="/just_timer">
      <JustTimer />
    </Route>
    <Route path="/markdown_editor">
      <MarkdownEditor />
    </Route>
    <Route path="/browser_tabs">
      <BrowserTabs />
    </Route>
    <Route path="/paper_rock_scissors">
      <PaperRockScissors />
    </Route>
    <Route path="/infinite_image_gallery">
